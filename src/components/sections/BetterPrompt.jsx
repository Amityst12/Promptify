    ...
    >
      <RevealOnScroll>
        <div className="text-center z-10 max-w-2xl mx-auto">
          ...
          <input
            type="text"
            className="w-full p-3 rounded bg-cyan-900 text-white border border-gray-700 mb-4"
          ...
          {improvedPrompt && (
            <div className="mt-6 p-4 bg-cyan-900 rounded text-blue-300 border border-gray-700 text-left">
